...
class NewsFormIntegrationTest extends TestCase
{
    ...
    public function it_can_create_news_with_all_fields()
    {
        $data = [
            ...
            'category' => 'Berita',
            'featured_image' => UploadedFile::fake()->image('news.jpg', 1200, 675),
            'is_published' => true
        ];
    ...
    public function it_can_update_existing_news()
    {
        ...
        $data = [
            ...
            'featured_image' => UploadedFile::fake()->image('updated.jpg', 1200, 675),
            'is_published' => true
        ];
    ...
    public function it_can_upload_gallery_images()
    {
        $data = [
            ...
            'is_published' => true,
            'slide_images' => [
                UploadedFile::fake()->image('gallery1.jpg', 800, 450),
                UploadedFile::fake()->image('gallery2.jpg', 800, 450),
                UploadedFile::fake()->image('gallery3.jpg', 800, 450)
            ]
        ];
    ...
    public function it_limits_gallery_images_to_seven()
    {
        ...
        $data = [
            ...
            'is_published' => true,
            'slide_images' => [
                UploadedFile::fake()->image('extra.jpg', 800, 450)
            ]
        ];
