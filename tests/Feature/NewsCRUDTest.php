...
class NewsCRUDTest extends TestCase
{
    ...
    public function admin_can_create_news_with_slide_images()
    {
        ...
        $data = [
            ...
            'published_at' => now()->format('Y-m-d\TH:i'),
            'slide_images' => [
                UploadedFile::fake()->image('slide1.jpg', 800, 450),
                UploadedFile::fake()->image('slide2.jpg', 800, 450),
            ],
        ];
    ...
    public function admin_can_update_news_with_new_featured_image()
    {
        ...
        $data = [
            ...
            'is_published' => true,
            'published_at' => now()->format('Y-m-d\TH:i'),
            'featured_image' => UploadedFile::fake()->image('new-image.jpg', 1200, 675),
        ];
    ...
    public function admin_can_add_slide_images_to_existing_news()
    {
        ...
        $data = [
            ...
            'published_at' => now()->format('Y-m-d\TH:i'),
            'slide_images' => [
                UploadedFile::fake()->image('new-slide.jpg', 800, 450),
            ],
        ];
