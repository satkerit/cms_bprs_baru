...
class NewsTest extends TestCase
{
    ...
    #[Test]
    public function content_is_sanitized_when_set(): void
    {
        $news = new News();
        $news->content = '<p>Safe</p><script>alert(1)</script>';
    ...
    public function cache_is_cleared_on_save(): void
    {
        ...
        $cached = \Illuminate\Support\Facades\Cache::get('news_home_3');
        $this->assertNull($cached);
    }

    #[Test]
    public function unpublished_news_dont_appear_in_published_scope(): void
    {
    ...
    #[Test]
    public function scheduled_news_dont_appear_in_published_scope(): void
    {
