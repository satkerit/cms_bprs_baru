...
class News extends Model
{
    ...
    {
        static::saved(fn() => Cache::forget(Config::get('cache-keys.news_home')));
        static::deleted(fn() => Cache::forget(Config::get('cache-keys.news_home')));

        // Invalidate full-page response cache so public pages reflect changes
