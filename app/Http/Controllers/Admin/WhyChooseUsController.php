...
use App\Http\Requests\Admin\WhyChooseUs\StoreWhyChooseUsRequest;
...
class WhyChooseUsController extends Controller
{
    ...
    public function store(StoreWhyChooseUsRequest $request)
    {
        ...
        try {
            ...
            app(CacheService::class)->clear('why_choose_us_items');
     ...
     */
    public function update(UpdateWhyChooseUsRequest $request, WhyChooseUs $whyChooseUs)
    {
        $this->authorizeEdit('why_choose_us.manage');
        $validated = $request->validated();
    ...
    public function updateSettings(Request $request)
    {
        ...
        try {
            ...
            app(CacheService::class)->clear('why_choose_us_settings');
