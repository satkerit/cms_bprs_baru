...
class WebPConverterService
{
     ...
     * @return array
     */
    public static function convertToWebP(string $originalPath, $options = []): array
    {
        if (is_int($options)) {
        ...
        try {
            ...
            $breakpoints = $options['breakpoints'] ?? ImageService::BREAKPOINTS;
     ...
     * @return array
     */
    public static function convertToAVIF(string $originalPath, $options = []): array
    {
        if (is_int($options)) {
            $options = ['quality' => $options];
        } elseif (!is_array($options)) {
    ...
    {
        return ImageService::getExistingResponsiveWebP($originalPath);
    }
    ...
    {
        return ImageService::getExistingResponsiveAVIF($originalPath);
    }
    ...
    {
        return ImageService::getExistingWebP($originalPath);
    }
    ...
    {
        return ImageService::getExistingAVIF($originalPath);
    }

    /**
     * Generate responsive WebP sizes for an image
     *
     * @param string $originalPath
     * @return array Responsive WebP versions keyed by breakpoint name
     */
    public static function generateResponsiveWebP(string $originalPath): array
    {
        return self::convertToWebP($originalPath);
    }
    ...
    {
        return ImageService::isAVIFSupported();
    }
