...
return new class extends Migration
{
    ...
    {
        // Ensure hero-slider-settings menu exists with correct route name
        $exists = DB::table('admin_menus')->where('key', 'hero-slider-settings')->exists();
        
        if (!$exists) {
            // If menu doesn't exist in DB, create it
            ...
            // If menu exists, ensure route name is correct
            DB::table('admin_menus')
                ->where('key', 'hero-slider-settings')
                ->update([
                    'route' => 'admin.hero-slider-settings.edit',
    ...
    {
        // Optional: remove hero-slider-settings menu
