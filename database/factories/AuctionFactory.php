...
class AuctionFactory extends Factory
{
    ...
    {
        $assetTypes = array_map(fn($case) => $case->value, AssetType::cases());
        $certificateTypes = array_map(fn($case) => $case->value, CertificateType::cases());
        $auctionTypes = array_map(fn($case) => $case->value, AuctionType::cases());
