...
<form action="{{ isset($office) ? route('admin.offices.update', $office) : route('admin.offices.store') }}" method="POST" enctype="multipart/form-data">
 ...
 <a :href="directionsUrl" target="_blank" class="inline-flex items-center gap-1 text-sky-600">
 ...
 hint="Format: JPG, PNG, WebP. Maks 2MB. Rekomendasi: 1200x800px (3:2). Minimal: 400x300px."
