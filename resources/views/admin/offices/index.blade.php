...
<x-admin.card :noPadding="true">
 ...
 <a href="{{ route('admin.offices.index') }}" class="inline-flex items-center px-4 py-2 text-[13px] font-medium dark:text-slate-300 dark:text-slate-300 text-zinc-700 bg-white border dark:border-slate-700 border-zinc-200 rounded-xl hover:dark:bg-slate-800/50 dark:bg-slate-800/50 bg-zinc-50 transition-colors">
 Reset
 </a>
 @endif
 </div>
 ...
 @else
 <div class="w-16 h-16 rounded-lg flex items-center justify-center shrink-0 dark:bg-slate-800/50 dark:bg-slate-800/50 bg-zinc-50">
 ...
 <p class="text-xs dark:text-slate-400 dark:text-slate-400 text-zinc-500 line-clamp-2">{{ $office->address }}</p>
 </div>
 </div>
 ...
 <div class="text-xs dark:text-slate-400 dark:text-slate-400 text-zinc-500 mb-3">
 ...
 @empty
 <div class="text-center py-8 dark:text-slate-400 dark:text-slate-400 text-zinc-500">Belum ada data kantor.</div>
 @endforelse
 </div>
 ...
 @else
 <div class="w-12 h-12 rounded-lg flex items-center justify-center shrink-0 dark:bg-slate-800/50 dark:bg-slate-800/50 bg-zinc-50">
 ...
 <p class="text-xs dark:text-slate-400 dark:text-slate-400 text-zinc-500 max-w-[200px]">{{ Str::limit($office->address, 50) }}</p>
 </div>
 </div>
 </td>
 <td class="px-6 py-4">
 ...
 <td class="px-6 py-4 text-sm dark:text-slate-400 dark:text-slate-400 text-zinc-500">
 ...
 <a href="{{ route('admin.offices.edit', $office) }}" class="p-1.5 dark:text-slate-400 dark:text-slate-400 text-zinc-500 hover:dark:text-slate-300 dark:text-slate-300 text-zinc-700 hover:dark:bg-slate-800 dark:bg-slate-800 bg-zinc-100 rounded-lg transition-colors">
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
 </svg>
 </a>
 <button type="button" data-open-modal="deleteOffice{{ $office->id }}" class="p-1.5 dark:text-slate-400 dark:text-slate-400 text-zinc-500 hover:text-red-600 rounded-lg transition-colors" title="Hapus">
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 ...
 @empty
 <tr><td colspan="5" class="px-6 py-8 text-center dark:text-slate-400 dark:text-slate-400 text-zinc-500">Belum ada data kantor.</td></tr>
 @endforelse
 </x-admin.table>
 </div>
