 ...
 * { margin: 0; padding: 0; box-sizing: border-box; }
 ...
 /* ── HEADER ── */
 .report-header {
 background: linear-gradient(135deg, #1a1a2e 0%, #a16207 100%);
 color: #fff;
 padding: 24px 32px;
 display: flex;
 align-items: center;
 ...
 .header-divider {
 height: 4px;
 background: linear-gradient(90deg, #a16207, #d97706, #f59e0b, #fbbf24);
 }
 ...
 thead tr {
 background: linear-gradient(135deg, #1a1a2e, #a16207);
 color: #fff;
 }
 thead th {
 padding: 9px 10px;
 ...
 .ticket-num { font-weight: 700; color: #a16207; font-size: 10px; }
 ...
 */
 ...
 .btn-print:hover { background: #854d0e; }
 .btn-back {
 background: #fff;
 color: #475569;
 border: 1px solid #e2e8f0;
...
<div class="print-toolbar no-print">
 ...
 <button class="btn-print" data-action="print">
