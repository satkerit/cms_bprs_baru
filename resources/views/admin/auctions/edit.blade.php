            ...
            <x-admin.card title="Gambar Aset" subtitle="Upload minimal 3 gambar aset yang dilelang">
                <div>
                    <div class="relative">
                        ...
                        <label for="images" class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-zinc-300 rounded-xl cursor-pointer hover:border-blue-500 hover:bg-emerald-50 transition-all">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="text-[11px] text-zinc-500 font-medium">Upload Gambar Baru</p>
                    ...
                    @if($auction->images && count($auction->images) > 0)
                        <div class="mt-6">
                            <p class="text-[13px] font-medium text-zinc-700 mb-3">Gambar Saat Ini ({{ count($auction->images) }} gambar):</p>
                                ...
                                @foreach($auction->images as $image)
                                    <div class="relative group">
                                        ...
                                        <div class="absolute top-2 right-2">
                                            <label class="flex items-center space-x-1 bg-white bg-opacity-95 rounded-md px-2 py-1 shadow-sm cursor-pointer hover:bg-red-50 transition-colors border border-zinc-200">
                                                <input type="checkbox" name="delete_images[]" value="{{ $image }}" class="rounded text-red-600 focus:ring-red-500 border-zinc-300 w-4 h-4">
