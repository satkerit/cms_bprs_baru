...
@section('content')
<x-admin.page-header title="Edit Lelang Agunan" subtitle="Perbarui informasi lelang agunan dengan detail yang akurat">
    <x-slot:actions>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <x-admin.card title="Informasi Objek" subtitle="Detail spesifikasi objek lelang">
                <div class="space-y-5">
                    ...
                    <div class="bg-blue-50 p-4 rounded-xl border border-blue-200">
                        <h4 class="text-[13px] font-semibold text-blue-900 mb-3">Informasi Sertifikat</h4>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                    ...
                    <div class="dark:bg-slate-800/50 dark:bg-slate-800/50 bg-zinc-50 p-4 rounded-xl border dark:border-slate-700 border-zinc-200">
                        ...
                        <div class="mt-4">
                            ...
                            <select name="building_condition" id="building_condition" class="w-full px-4 py-2.5 border dark:border-slate-700 border-zinc-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-colors @error('building_condition') border-red-500 @enderror">
                                ...
                                <option value="sangat_baik" {{ old('building_condition', $auction->building_condition) === 'sangat_baik' ? 'selected' : '' }}>Sangat Baik</option>
                                <option value="baik" {{ old('building_condition', $auction->building_condition) === 'baik' ? 'selected' : '' }}>Baik</option>
                                <option value="cukup" {{ old('building_condition', $auction->building_condition) === 'cukup' ? 'selected' : '' }}>Cukup</option>
                                <option value="perlu_renovasi" {{ old('building_condition', $auction->building_condition) === 'perlu_renovasi' ? 'selected' : '' }}>Perlu Renovasi</option>
                                <option value="rusak" {{ old('building_condition', $auction->building_condition) === 'rusak' ? 'selected' : '' }}>Rusak</option>
                            </select>
                ...
                <div class="space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="creditor_name" id="creditor_name" value="{{ old('creditor_name', $auction->creditor_name) }}"
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="debt_amount" id="debt_amount" value="{{ old('debt_amount', $auction->debt_amount) }}"
                    ...
                    <div>
                        ...
                        <textarea name="legal_basis" id="legal_basis" rows="3"
                                  ...
                                  placeholder="Dasar hukum pelaksanaan lelang...">{{ old('legal_basis', $auction->legal_basis) }}</textarea>
                        @error('legal_basis')
                            <p class="mt-1.5 text-[13px] text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="court_decision" id="court_decision" value="{{ old('court_decision', $auction->court_decision) }}"
                        ...
                        <div>
                            ...
                            <input type="date" name="court_decision_date" id="court_decision_date" value="{{ old('court_decision_date', isset($auction->court_decision_date) ? $auction->court_decision_date->format('Y-m-d') : '') }}"
                    ...
                    <div>
                        ...
                        <textarea name="encumbrance_details" id="encumbrance_details" rows="3"
                                  ...
                                  placeholder="Detail hak tanggungan...">{{ old('encumbrance_details', $auction->encumbrance_details) }}</textarea>
                ...
                <div class="space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="bank_name" id="bank_name" value="{{ old('bank_name', $auction->bank_name) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="bank_branch" id="bank_branch" value="{{ old('bank_branch', $auction->bank_branch) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="account_number" id="account_number" value="{{ old('account_number', $auction->account_number) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="account_holder" id="account_holder" value="{{ old('account_holder', $auction->account_holder) }}"
                ...
                <div class="space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="datetime-local" name="viewing_start" id="viewing_start" value="{{ old('viewing_start', $auction->viewing_start ? $auction->viewing_start->format('Y-m-d\TH:i') : '') }}"
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="viewing_end" id="viewing_end" value="{{ old('viewing_end', $auction->viewing_end ? $auction->viewing_end->format('Y-m-d\TH:i') : '') }}"
                    ...
                    <div>
                        ...
                        <textarea name="viewing_schedule" id="viewing_schedule" rows="3"
                                  ...
                                  placeholder="Contoh: Senin - Jumat, Pukul 09.00 - 15.00 WIB">{{ old('viewing_schedule', $auction->viewing_schedule) }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="viewing_contact" id="viewing_contact" value="{{ old('viewing_contact', $auction->viewing_contact) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="viewing_notes" id="viewing_notes" value="{{ old('viewing_notes', $auction->viewing_notes) }}"
            ...
            <x-admin.card title="Informasi Kontak" subtitle="Detail kontak person lelang">
                <div x-data="{
                    contacts: @js(old('contacts', $auction->contacts ?? (($auction->contact_person) ? [['name' => $auction->contact_person, 'phone' => $auction->contact_phone]] : [['name' => '', 'phone' => '']])))
                }" class="space-y-5">
                    ...
                    <button type="button" @click="contacts.push({name: '', phone: ''})" class="flex items-center text-[13px] font-medium text-blue-600 hover:text-emerald-700 transition-colors">
        ...
        <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="status" id="status" class="w-full px-4 py-2.5 border dark:border-slate-700 border-zinc-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-colors">
                            @foreach(\App\Enums\AuctionStatus::cases() as $status)
                                <option value="{{ $status->value }}" {{ old('status', $auction->status) === $status->value ? 'selected' : '' }}>
                                    {{ $status->label() }}
                                </option>
                            @endforeach
                        </select>
            ...
            <x-admin.card title="Gambar Aset" subtitle="Upload minimal 3 gambar aset yang dilelang">
                <div>
                    <div class="relative">
                        <input type="file" name="images[]" id="images" accept="image/*" multiple class="hidden" data-action="preview-images">
                        <label for="images" class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed dark:border-slate-600 border-zinc-300 rounded-xl cursor-pointer hover:border-blue-500 hover:bg-emerald-50 transition-all">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="text-[11px] dark:text-slate-400 dark:text-slate-400 text-zinc-500 font-medium">Upload Gambar Baru</p>
                                <p class="text-[11px] dark:text-slate-500 dark:text-slate-500 text-zinc-400">PNG, JPG, WEBP (Max 5MB per file)</p>
                                <p class="text-[13px] text-amber-600 font-medium mt-1">Opsional - kosongkan jika tidak ingin mengubah</p>
                            </div>
                        </label>
                    </div>
                    ...
                    @if($auction->images && count($auction->images) > 0)
                        <div class="mt-6">
                            <p class="text-[13px] font-medium dark:text-slate-300 dark:text-slate-300 text-zinc-700 mb-3">Gambar Saat Ini ({{ count($auction->images) }} gambar):</p>
                            <div class="grid grid-cols-2 gap-4">
                                @foreach($auction->images as $image)
                                    <div class="relative group">
                                        <img src="{{ \App\Helpers\StorageHelper::url($image) }}"
                                             alt="Auction Image"
                                             class="w-full h-24 object-cover rounded-xl shadow-md group-hover:shadow-lg transition-shadow">
                                        <div class="absolute top-2 right-2">
                                            <label class="flex items-center space-x-1 bg-white bg-opacity-95 rounded-md px-2 py-1 shadow-sm cursor-pointer hover:bg-red-50 transition-colors border dark:border-slate-700 border-zinc-200">
                                                <input type="checkbox" name="delete_images[]" value="{{ $image }}" class="rounded text-red-600 focus:ring-red-500 dark:border-slate-600 border-zinc-300 w-4 h-4">
                                                <span class="text-[11px] font-bold text-red-600">Hapus</span>
                                            </label>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
                            @if(count($auction->images) >= 3)
                                <p class="mt-2 text-[13px] text-emerald-600">
                                    <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                                    </svg>
                                    Sudah memenuhi minimal 3 gambar
                                </p>
                            @else
                                <p class="mt-2 text-[13px] text-amber-600">
                                    ...
                                    Disarankan minimal 3 gambar untuk lelang
                                </p>
                            @endif
                            <p class="mt-2 text-[13px] text-emerald-600">
                                <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @else
                        <div class="mt-4 p-4 bg-amber-50 border border-amber-200 rounded-xl">
                            <p class="text-[13px] text-amber-700">
                                ...
                                Belum ada gambar. Disarankan upload minimal 3 gambar untuk lelang.
                            </p>
                        </div>
                    @endif
                </div>
        ...
        if (file.type.startsWith('image/')) {
            ...
            reader.onload = function(e) {
                ...
                div.innerHTML = `
                    ...
                    <button type="button" data-action="remove-image" data-index="${i}"
                            class="absolute -top-2 -right-2 w-6 h-6 bg-red-500 text-white rounded-lg text-[13px] hover:bg-red-600">
                        Ã—
                    </button>
                `;
...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelector('[data-action="preview-images"]')?.addEventListener('change', function(e) {
        previewImages(e);
    });
