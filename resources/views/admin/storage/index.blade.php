...
<x-admin.page-header title="File Manager" subtitle="Kelola file dan folder di storage">
 <x-slot:actions>
 <a href="{{ route('admin.storage.orphaned') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-red-50 border border-red-200 text-red-700 text-[11px] font-medium rounded-xl hover:bg-red-100 transition-colors">
