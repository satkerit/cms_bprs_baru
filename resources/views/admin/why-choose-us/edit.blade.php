...
<div class="max-w-7xl mx-auto px-4 sm:px-6">
 ...
 <div>
 <h2 class="text-3xl font-bold text-zinc-900 tracking-tight">Edit Item</h2>
 <p class="text-zinc-500">Perbarui informasi poin keunggulan.</p>
 </div>
 </div>
 ...
 <input type="text" name="title" value="{{ old('title', $whyChooseUs->title) }}" required class="w-full px-4 py-2.5 rounded-xl border-zinc-300 text-zinc-900 font-medium">
 ...
 <input type="number" name="sort_order" value="{{ old('sort_order', $whyChooseUs->sort_order) }}" min="0" required class="w-full px-4 py-2.5 rounded-xl border-zinc-300 text-zinc-900 font-medium">
 </div>
 </div>
 ...
 <textarea name="description" rows="3" required class="w-full px-4 py-3 rounded-xl border-zinc-300 text-zinc-900 font-medium resize-none">{{ old('description', $whyChooseUs->description) }}</textarea>
 ...
 <div x-data="{ preview: '{{ $whyChooseUs->icon ? \App\Helpers\StorageHelper::url($whyChooseUs->icon) : null }}' }" class="border-2 border-dashed border-zinc-200 rounded-xl p-6 text-center hover:border-indigo-400 bg-zinc-50">
 ...
 <div>
 <p class="text-[11px] font-semibold text-zinc-500">Upload Icon Baru</p>
 ...
 <div class="w-12 h-7 bg-zinc-200 after:content-[''] after: after:top-[3px] after:left-[3px] after:bg-white after:border-zinc-300 after:border after:rounded-full after:h-5 after:w-5 after: -checked:bg-indigo-500 after:"></div>
 </div>
 <div>
 ...
 <a href="{{ route('admin.why-choose-us.index') }}" class="px-6 py-3 bg-white text-zinc-500 font-semibold rounded-xl border text-center">Batal</a>
