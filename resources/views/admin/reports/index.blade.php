...
<x-admin.card :noPadding="true">
 ...
 <a href="{{ route('admin.reports.index') }}" class="inline-flex items-center px-4 py-2 text-[13px] font-medium text-zinc-700 bg-white rounded-xl">
 Reset
 </a>
 @endif
 </div>
 ...
 <div class="mb-3">
 <p class="font-semibold text-zinc-900 line-clamp-2">{{ $report->title }}</p>
 <p class="text-[13px] text-zinc-500 mt-1">{{ $report->file_size ? number_format($report->file_size / 1024 / 1024, 2) . ' MB' : '-' }}</p>
 </div>
 ...
 <td class="px-4 py-3 text-[13px] text-zinc-500">{{ number_format($report->download_count ?? 0) }}x</td>
 <td class="px-4 py-3">
 <div class="flex items-center gap-1">
 @if($report->file_path)
 <a href="{{ \App\Helpers\StorageHelper::url($report->file_path) }}" target="_blank" class="p-1.5 text-zinc-500 hover:bg-sky-100 rounded-xl">
 ...
 @endif
 <a href="{{ route('admin.reports.edit', $report) }}" class="p-1.5 text-zinc-500 rounded-xl">
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
 </svg>
 </a>
 <button type="button" data-open-modal="deleteReport{{ $report->id }}" class="p-1.5 text-zinc-500 rounded-xl hover:text-red-600">
 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
