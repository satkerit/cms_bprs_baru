...
<x-admin.card :noPadding="true">
 ...
 <p class="font-semibold dark:text-slate-100 dark:text-slate-100 text-zinc-900 truncate">{{ $brochure->original_name }}</p>
 <a href="{{ $brochure->download_url }}" target="_blank" class="text-[13px] text-blue-600 hover:underline">Download</a>
 </div>
 </div>

 <div class="grid grid-cols-2 gap-3 mb-4 text-[13px] dark:text-slate-300 dark:text-slate-300 text-zinc-600">
 <div>
 <span class="text-[11px] dark:text-slate-500 dark:text-slate-500 text-zinc-400 block">Ukuran</span>
 {{ number_format($brochure->file_size / 1024, 2) }} KB
 </div>
 <div>
 <span class="text-[11px] dark:text-slate-500 dark:text-slate-500 text-zinc-400 block">Diunggah</span>
 {{ $brochure->created_at->format('d M Y') }}
 </div>
 <div class="col-span-2">
 <span class="text-[11px] dark:text-slate-500 dark:text-slate-500 text-zinc-400 block">Oleh</span>
 ...
 <h3 class="text-lg font-semibold dark:text-slate-100 dark:text-slate-100 text-zinc-900 mb-1">Belum Ada Brosur</h3>
 <p class="dark:text-slate-400 dark:text-slate-400 text-zinc-500 mb-4">Klik tombol "Upload Brosur" untuk menambahkan</p>
 ...
 <button type="button" data-open-modal="deleteBrochure{{ $brochure->id }}" class="p-2 dark:text-slate-500 dark:text-slate-500 text-zinc-400 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all" title="Hapus">
 ...
 <p class="dark:text-slate-400 dark:text-slate-400 text-zinc-500 font-medium">Belum ada brosur</p>
 <p class="text-[13px] dark:text-slate-500 dark:text-slate-500 text-zinc-400 mt-1">Klik tombol "Upload Brosur" untuk menambahkan</p>
 </td>
 </tr>
 @endforelse
 </x-admin.table>
