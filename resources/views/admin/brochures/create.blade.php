...
<x-admin.card>
 ...
 :class="{ 'border-blue-500 bg-emerald-50': isDropping, 'border-zinc-300 hover:border-blue-400': !isDropping }"
...
>
 ...
 type="button" 
 @click="uploadFile()"
 class="px-4 py-2 text-[13px] font-medium text-white bg-blue-600 rounded-xl hover:bg-blue-700 disabled:opacity-50"
 :disabled="isUploading"
>
 ...
 <div x-show="errorMessage" x-text="errorMessage" class="mt-4 text-[13px] text-red-600 font-medium" style="display: none;"></div>
 </div>
 </div>
</x-admin.card>
