...
<div class="container is-max-widescreen">
 ...
 class="block w-full rounded-lg border-gray-300 text-xs @error('admin_email') border-red-300 @enderror">
 @error('admin_email')
 ...
 class="block w-full rounded-lg border-gray-300 text-xs @error('cc_emails') border-red-300 @enderror">
 @error('cc_emails')
 <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
 @enderror
 ...
 <div>
 <p class="text-xs font-medium text-gray-900">Notifikasi Pengaduan Baru</p>
 <p class="text-xs text-gray-500">Kirim email ke admin saat ada pengaduan baru masuk</p>
 </div>
 <label class="inline-flex items-center">
 <input type="checkbox" name="notify_on_new" value="1" 
 ...
 <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
 <div>
 <p class="text-xs font-medium text-gray-900">Notifikasi Perubahan Status</p>
 ...
 <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
 <div>
 <p class="text-xs font-medium text-gray-900">Konfirmasi ke Nasabah</p>
 <p class="text-xs text-gray-500">Kirim email konfirmasi ke nasabah setelah pengaduan diterima</p>
 </div>
 <label class="inline-flex items-center">
 <input type="checkbox" name="send_confirmation_to_customer" value="1" 
 ...
 <div class="space-y-4">
 <p class="text-xs text-gray-700">Tentukan batas waktu penanganan (hari kerja) berdasarkan prioritas pengaduan.</p>
 <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
 <div>
 <label class="block text-xs font-medium text-gray-700 mb-1">
 Prioritas Rendah
 ...
 class="block w-full rounded-lg border-gray-300 text-xs @error('sla_days_low') border-red-300 @enderror">
 ...
 class="block w-full rounded-lg border-gray-300 text-xs @error('sla_days_medium') border-red-300 @enderror">
 <span class="text-xs text-gray-500">hari</span>
 </div>
 ...
 class="block w-full rounded-lg border-gray-300 text-xs @error('sla_days_high') border-red-300 @enderror">
 <span class="text-xs text-gray-500">hari</span>
 </div>
 @error('sla_days_high')
 <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
 ...
 <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
 <div>
 <label class="block text-xs font-medium text-gray-700 mb-1">Prefix Nomor Tiket</label>
 <input type="text" name="ticket_prefix" maxlength="10"
 value="{{ old('ticket_prefix', $settings->ticket_prefix) }}"
 placeholder="ADU"
 class="block w-full rounded-lg border-gray-300 text-xs @error('ticket_prefix') border-red-300 @enderror">
 @error('ticket_prefix')
 <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
 @enderror
 ...
 <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
 <div>
 <p class="text-xs font-medium text-gray-900">Wajibkan Nomor Rekening</p>
 <p class="text-xs text-gray-500">Nasabah harus mengisi nomor rekening saat mengadu</p>
 </div>
 <label class="inline-flex items-center">
 <input type="checkbox" name="require_account_number" value="1" 
 ...
 <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
 <div>
 <p class="text-xs font-medium text-gray-900">Wajibkan Nomor Telepon</p>
 ...
 <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
 <div>
 <p class="text-xs font-medium text-gray-900">Izinkan Lampiran File</p>
 <p class="text-xs text-gray-500">Nasabah dapat melampirkan dokumen pendukung</p>
 </div>
 <label class="inline-flex items-center">
 <input type="checkbox" name="allow_attachments" value="1" 
 ...
 <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
 <div>
 <p class="text-xs font-medium text-gray-900">Prioritas Otomatis</p>
 <p class="text-xs text-gray-500">Sistem otomatis menentukan prioritas berdasarkan kategori</p>
 </div>
 <label class="inline-flex items-center">
 <input type="checkbox" name="auto_assign_priority" value="1" 
 ...
 {{-- Pengaturan Lampiran --}}
 <div id="attachment_settings" class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2 border-t border-gray-200">
 <div>
 <label class="block text-xs font-medium text-gray-700 mb-1">Maks. Jumlah Lampiran</label>
 <input type="number" name="max_attachments" min="1" max="20"
 value="{{ old('max_attachments', $settings->max_attachments) }}"
 class="block w-full rounded-lg border-gray-300 text-xs @error('max_attachments') border-red-300 @enderror">
 @error('max_attachments')
 <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
 @enderror
 </div>
 <div>
 <label class="block text-xs font-medium text-gray-700 mb-1">Ukuran Maks. per File (MB)</label>
 <input type="number" name="max_file_size_mb" min="1" max="50"
 value="{{ old('max_file_size_mb', $settings->max_file_size_mb) }}"
 class="block w-full rounded-lg border-gray-300 text-xs @error('max_file_size_mb') border-red-300 @enderror">
 @error('max_file_size_mb')
 <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
 @enderror
 </div>
 <div>
 <label class="block text-xs font-medium text-gray-700 mb-1">Tipe File Diizinkan</label>
 ...
 class="block w-full rounded-lg border-gray-300 text-xs @error('allowed_file_types') border-red-300 @enderror">
 ...
 <div class="space-y-3">
 <p class="text-xs text-gray-700">Pilih kategori yang tersedia untuk nasabah saat mengajukan pengaduan.</p>
 <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
 ...
 <div class="space-y-4">
 <div>
 <label class="block text-xs font-medium text-gray-700 mb-1">Teks Pengantar Form</label>
 <textarea name="form_intro_text" rows="3"
 placeholder="Tuliskan pengantar atau instruksi untuk nasabah sebelum mengisi form..."
 class="block w-full rounded-lg border-gray-300 text-xs @error('form_intro_text') border-red-300 @enderror">{{ old('form_intro_text', $settings->form_intro_text) }}</textarea>
 ...
 <div>
 <label class="block text-xs font-medium text-gray-700 mb-1">Pesan Sukses</label>
 <textarea name="success_message" rows="3"
 placeholder="Pesan yang ditampilkan setelah nasabah berhasil mengirim pengaduan..."
 class="block w-full rounded-lg border-gray-300 text-xs @error('success_message') border-red-300 @enderror">{{ old('success_message', $settings->success_message) }}</textarea>
 ...
 <div>
 <label class="block text-xs font-medium text-gray-700 mb-1">Syarat & Ketentuan</label>
 <textarea name="terms_text" rows="5"
 placeholder="Tuliskan syarat dan ketentuan pengajuan pengaduan..."
 class="block w-full rounded-lg border-gray-300 text-xs @error('terms_text') border-red-300 @enderror">{{ old('terms_text', $settings->terms_text) }}</textarea>
 @error('terms_text')
 <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
 @enderror
 ...
 class="inline-flex items-center px-4 py-2 text-xs font-medium text-gray-700 bg-white rounded-lg">
 Lihat Pengaduan
 </a>
