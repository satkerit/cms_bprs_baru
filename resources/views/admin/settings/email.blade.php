        ...
        <div class="space-y-6">
            ...
            <x-admin.card title="Panduan Konfigurasi">
                <div class="space-y-4 text-xs">
                    <div class="p-3 bg-sky-100 dark:bg-sky-900/20 rounded-lg">
                        <p class="font-medium text-sky-700 dark:text-sky-400 mb-1">Gmail SMTP</p>
                        <ul class="text-sky-700 dark:text-sky-400 text-xs space-y-1">
                    ...
                    <div class="p-3 bg-sky-100 dark:bg-sky-900/20 rounded-lg">
                        <p class="font-medium text-sky-700 dark:text-sky-400 mb-1">Yahoo SMTP</p>
                        <ul class="text-sky-700 dark:text-sky-400 text-xs space-y-1">
                    ...
                    <div class="p-3 bg-amber-100 dark:bg-amber-900/20 rounded-lg">
                        <p class="font-medium text-amber-700 dark:text-amber-400 mb-1">Outlook/Office 365</p>
                        <ul class="text-amber-700 dark:text-amber-400 text-xs space-y-1">
