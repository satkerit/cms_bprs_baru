...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
 ...
 <div>
 <p class="text-[11px] text-zinc-500 mb-1">Total IP Terblokir</p>
 <p class="text-3xl font-bold text-zinc-900">{{ $blockedIpsCount }}</p>
 </div>
 ...
 <div class="flex items-center justify-between">
 <div>
 <p class="text-[11px] text-zinc-500 mb-1">Blokir Permanen</p>
 <p class="text-3xl font-bold text-zinc-900">{{ $permanentBlocksCount }}</p>
 </div>
 ...
 <div class="flex items-center justify-between">
 <div>
 <p class="text-[11px] text-zinc-500 mb-1">Blokir Sementara</p>
 <p class="text-3xl font-bold text-zinc-900">{{ $temporaryBlocksCount }}</p>
 </div>
...
<form action="{{ route('admin.settings.security.update') }}" method="POST">
 ...
 <x-admin.card>
 <div class="mb-6">
 <h3 class="text-lg font-bold text-zinc-900 mb-2">Rate Limiting</h3>
 <p class="text-[11px] text-zinc-500">Batasi jumlah request untuk mencegah abuse</p>
 </div>
 ...
 <p class="text-[11px] text-zinc-500 mt-1">Jumlah maksimal request per menit untuk halaman publik</p>
 ...
 class="w-full rounded-xl border border-zinc-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
 <p class="text-[11px] text-zinc-500 mt-1">Jumlah maksimal request per menit untuk halaman admin</p>
 ...
 class="w-full rounded-xl border border-zinc-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
 <p class="text-[11px] text-zinc-500 mt-1">Jumlah maksimal percobaan login per menit</p>
 ...
 class="w-full rounded-xl border border-zinc-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
 <p class="text-[11px] text-zinc-500 mt-1">Jumlah maksimal request reset password per menit</p>
 ...
 class="w-full rounded-xl border border-zinc-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
 <p class="text-[11px] text-zinc-500 mt-1">Jumlah maksimal download per menit</p>
 ...
 <x-admin.card>
 <div class="mb-6">
 <h3 class="text-lg font-bold text-zinc-900 mb-2">IP Blocking</h3>
 <p class="text-[11px] text-zinc-500">Kelola pemblokiran IP otomatis</p>
 </div>
 ...
 class="w-full rounded-xl border border-zinc-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
 <p class="text-[11px] text-zinc-500 mt-1">Jumlah percobaan gagal sebelum IP diblokir</p>
 ...
 class="w-full rounded-xl border border-zinc-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
 <p class="text-[11px] text-zinc-500 mt-1">Durasi pemblokiran otomatis (1-168 jam / 1-7 hari)</p>
 ...
 <p class="text-[11px] text-zinc-500 mt-1">IP yang tidak akan pernah diblokir (satu per baris)</p>
 @error('ip_whitelist')
 <p class="text-[11px] text-red-600 mt-1">{{ $message }}</p>
 @enderror
 </div>
 ...
 <p class="text-[11px] text-zinc-500 mt-1">IP yang selalu diblokir (satu per baris)</p>
 @error('ip_blacklist')
 <p class="text-[11px] text-red-600 mt-1">{{ $message }}</p>
 @enderror
 </div>
 ...
 <div class="mb-6">
 <h3 class="text-lg font-bold text-zinc-900 mb-2">Fitur Keamanan</h3>
 <p class="text-[11px] text-zinc-500">Aktifkan atau nonaktifkan fitur keamanan</p>
 </div>
 ...
 <div class="ml-3">
 <label for="enable_suspicious_blocking" class="font-medium text-zinc-900">
 Enable Suspicious Request Blocking
 </label>
 <p class="text-[11px] text-zinc-500">Blokir otomatis request yang mencurigakan (SQL injection, XSS, dll)</p>
 </div>
 </div>
 ...
 <div class="ml-3">
 <label for="enable_rate_limiting" class="font-medium text-zinc-900">
 Enable Rate Limiting
 </label>
 <p class="text-[11px] text-zinc-500">Aktifkan pembatasan jumlah request</p>
 </div>
 </div>
 ...
 <div class="ml-3">
 <label for="log_security_events" class="font-medium text-zinc-900">
 Log Security Events
 </label>
 <p class="text-[11px] text-zinc-500">Catat semua event keamanan ke log file</p>
 </div>
 </div>
 </div>
 </x-admin.card>
 ...
 <x-admin.card class="mt-6">
 <div class="mb-6">
 <h3 class="text-lg font-bold text-zinc-900 mb-2">Manajemen Sesi Admin</h3>
 <p class="text-[11px] text-zinc-500">Atur pengaturan sesi dan idle timeout untuk admin</p>
 </div>
 ...
 class="w-full rounded-xl border border-zinc-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
 <p class="text-[11px] text-zinc-500 mt-1">Durasi maksimal sesi (30-1440 menit / 0.5-24 jam)</p>
 ...
 class="w-full rounded-xl border border-zinc-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
 <p class="text-[11px] text-zinc-500 mt-1">Waktu idle sebelum auto logout (5-480 menit / 5 menit - 8 jam)</p>
 @error('idle_timeout')
 <p class="text-[11px] text-red-600 mt-1">{{ $message }}</p>
 @enderror
 </div>
 ...
 class="w-full rounded-xl border border-zinc-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
 <p class="text-[11px] text-zinc-500 mt-1">Waktu warning sebelum idle timeout (harus lebih kecil dari idle timeout)</p>
 @error('idle_warning')
 <p class="text-[11px] text-red-600 mt-1">{{ $message }}</p>
 @enderror
 </div>
 ...
 <div class="ml-3">
 <label for="auto_extend_session" class="font-medium text-zinc-900">
 Auto Extend Session
 </label>
 <p class="text-[11px] text-zinc-500">Perpanjang sesi otomatis saat ada aktivitas user</p>
 </div>
 </div>
 ...
 <div class="ml-3">
 <label for="enable_session_tracking" class="font-medium text-zinc-900">
 Enable Session Tracking
 </label>
 <p class="text-[11px] text-zinc-500">Aktifkan pelacakan aktivitas sesi untuk keamanan</p>
 </div>
 </div>
 </x-admin.card>
...
<x-admin.card class="mt-6">
 <div class="mb-6">
 <h3 class="text-lg font-bold text-zinc-900 mb-2">IP Terblokir Terbaru</h3>
 <p class="text-[11px] text-zinc-500">10 IP yang baru saja diblokir</p>
 </div>
 ...
 <th class="pl-4 pr-5 py-3.5 text-left text-[11px] font-semibold text-zinc-500 uppercase tracking-[0.05em]">Type</th>
 </tr>
 </thead>
