                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center gap-2">
                            ...
                            <label for="enable_autoplay" class="text-[13px] dark:text-slate-300 dark:text-slate-300 text-zinc-700 font-medium">Aktifkan Auto-Play</label>
                        </div>
                        <div class="flex items-center gap-2">
                            ...
                            <label for="enable_touch_swipe" class="text-[13px] dark:text-slate-300 dark:text-slate-300 text-zinc-700 font-medium">Aktifkan Touch Swipe</label>
                        </div>
                        <div class="flex items-center gap-2">
                            ...
                            <label for="enable_navigation_arrows" class="text-[13px] dark:text-slate-300 dark:text-slate-300 text-zinc-700 font-medium">Aktifkan Panah Navigasi</label>
                        </div>
                        <div class="flex items-center gap-2">
                            ...
                            <label for="enable_dot_indicators" class="text-[13px] dark:text-slate-300 dark:text-slate-300 text-zinc-700 font-medium">Aktifkan Indikator Titik</label>
                        </div>
                    </div>
                </div>
            </x-admin.card>
            <x-admin.card title="Informasi">
                <div class="text-[13px] dark:text-slate-300 text-zinc-600 space-y-2">
