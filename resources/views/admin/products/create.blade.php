...
@section('content')
<x-admin.page-header title="Tambah Produk" subtitle="Buat produk baru untuk koperasi">
    <x-slot:actions>
...
<form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" x-data="{ type: '{{ old('type') }}' }">
    @csrf
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <select name="type" id="type" x-model="type" required class="block w-full rounded-xl border-0 py-2.5 px-4 text-slate-900 bg-slate-50 shadow-sm ring-1 ring-inset ring-slate-200 focus:bg-white focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6 hover:ring-slate-300 transition-all">
                            ...
                            <option value="deposito_syariah" {{ old('type') == 'deposito_syariah' ? 'selected' : '' }}>Deposito Syariah</option>
                        </select>
                        @error('type')
            ...
            <x-admin.card title="Fitur & Keunggulan" subtitle="Tambahkan fitur, keunggulan, dan persyaratan produk">
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div x-data="repeaterField(@js(old('features', [''])))" class="space-y-2">
                    ...
                    <div>
                        ...
                        <div x-data="repeaterField(@js(old('benefits', [''])))" class="space-y-2">
                            <template x-for="(item, index) in items" :key="item.id">
                                <div class="flex gap-2 group">
                    ...
                    <div>
                        ...
                        <div x-data="repeaterField(@js(old('requirements', [''])))" class="space-y-2">
                            <template x-for="(item, index) in items" :key="item.id">
                                <div class="flex gap-2 group">
