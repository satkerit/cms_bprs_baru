<div>
    ...
    <div class="text-center py-12" x-data x-init="$el.classList.add('animate-scale-in')">
        ...
        <div class="bg-emerald-50 p-6 max-w-md mx-auto mb-8 rounded-lg">
            ...
            <p class="text-xs text-emerald-700 mt-2">Simpan nomor ini untuk melacak status pengaduan Anda</p>
        </div>
    ...
    <form wire:submit="submit" class="space-y-8">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-1">
                    ...
                    <div class="relative">
                        <input type="text" wire:model.live="phone" class="w-full rounded-xl border border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-600">
                    </div>
                </div>
                <div class="space-y-1">
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Nomor Identitas (KTP/SIM)</label>
                    <div class="relative">
                        <input type="text" wire:model.live="identity_number" class="w-full rounded-xl border border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-600">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-1">
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Jenis Pelanggaran <span class="text-red-600">*</span></label>
                        <div class="relative">
                    ...
                    <div class="space-y-1">
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Subjek Laporan <span class="text-red-600">*</span></label>
                        <div class="relative">
                            <input type="text" wire:model.live="subject" class="w-full rounded-xl border border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-600 @error('subject') border-red-500 focus:ring-red-500 @enderror" placeholder="Ringkasan singkat laporan">
                        </div>
                        @error('subject') <p class="text-xs text-red-600 mt-1">{{ $message }}</p> @enderror
                    </div>
                </div>
                <div class="space-y-1">
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Deskripsi Lengkap <span class="text-red-600">*</span></label>
                    <div class="relative">
                        <textarea wire:model.live="description" rows="6" maxlength="5000" class="w-full rounded-xl border border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-600 @error('description') border-red-500 focus:ring-red-500 @enderror" placeholder="Jelaskan kronologi kejadian secara detail..."></textarea>
                    </div>
                    <div class="flex justify-between items-center mt-1">
                        @error('description') <p class="text-xs text-red-600">{{ $message }}</p> @else <p class="text-xs text-gray-500">Minimal 50 karakter</p> @enderror
                        <p class="text-xs {{ strlen($description) > 5000 ? 'text-red-600' : 'text-gray-500' }}">{{ strlen($description) }}/5000</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <h3 class="text-lg text-gray-900 font-bold mb-4 flex items-center">
                <span class="w-8 h-8 bg-red-50 flex items-center justify-center mr-3 rounded-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-1">
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Nama Pihak Terlapor</label>
                    <div class="relative">
                        <input type="text" wire:model.live="reported_person" class="w-full rounded-xl border border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-600">
                    </div>
                </div>
                <div class="space-y-1">
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Departemen/Unit</label>
                    <div class="relative">
                        <input type="text" wire:model.live="reported_department" class="w-full rounded-xl border border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-600">
                    </div>
                </div>
                <div class="space-y-1">
                ...
                <div class="space-y-1">
                    <label class="block text-sm font-semibold text-gray-700 mb-1">Lokasi Kejadian</label>
                    <div class="relative">
                        <input type="text" wire:model.live="incident_location" class="w-full rounded-xl border border-gray-300 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-600">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="mt-4 space-y-2">
                ...
                <div class="flex items-center justify-between p-3 bg-black/3 rounded-lg">
        ...
        <!-- Terms -->
        <div class="p-6 bg-black/3 rounded-lg">
            <label class="flex items-start cursor-pointer">
                <input type="checkbox" wire:model.live="agree_terms" class="mt-1 @error('agree_terms') border-red-500 @enderror">
                <div class="ml-4">
                    <span class="text-gray-500">Saya menyatakan bahwa laporan ini dibuat dengan itikad baik dan informasi yang saya berikan adalah benar. Saya memahami bahwa laporan palsu dapat dikenakan sanksi hukum.</span>
                </div>
            </label>
