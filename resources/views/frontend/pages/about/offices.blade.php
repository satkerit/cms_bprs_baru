                ...
                <div class="group bg-card rounded-lg shadow-gray-200/50 overflow-hidden hover:shadow-sm hover:shadow-emerald-500/10 transition-all duration-300 hover:-translate-y-1">
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex items-center gap-2 pt-4 border-t border-border">
                            ...
                            @if($office->has_coordinates)
                            <a href="https://www.google.com/maps/dir/?api=1&destination={{ $office->latitude }},{{ $office->longitude }}" target="_blank" rel="nofollow noopener noreferrer" class="inline-flex items-center justify-center px-4 py-2 border border-emerald-600 text-emerald-600 text-xs font-medium rounded-lg hover:bg-emerald-50 transition" title="Petunjuk Arah">
