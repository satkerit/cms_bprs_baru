                    ...
                    <div class="group bg-card rounded-xl border border-border overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300 flex flex-col">
                        ...
                        <div class="relative h-32 sm:h-36 bg-gradient-to-br {{ $c['bg'] }} flex items-center justify-center overflow-hidden">
                            ...
                            <div class="absolute inset-0 opacity-[0.07]">
                                <div class="absolute top-4 left-4 w-16 h-16 border-2 border-{{ $color }}-600 rounded-lg rotate-12"></div>
                                <div class="absolute bottom-4 right-4 w-20 h-20 border-2 border-{{ $color }}-600 rounded-lg -rotate-6"></div>
                                <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 border border-{{ $color }}-600/30 rounded-full"></div>
                            </div>
