<x-frontend-layout>
    ...
    <section class="relative pt-8 sm:pt-10 md:pt-12 pb-16 sm:pb-20 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-base sm:text-lg text-white/80 mx-auto leading-relaxed">Unduh logo resmi {{ $company?->name ?? 'BPRS Bangka Belitung' }} dalam berbagai format untuk keperluan media, publikasi, dan dokumentasi resmi.</p>
        </div>
    </section>

    <section class="py-12 sm:py-16">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-slate-900 rounded-lg sm:rounded-lg shadow-sm border border-border p-6 sm:p-8">
                @if($logoAvailable)
                    <!-- Logo Preview -->
