<x-frontend-layout>
    ...
    <section class="relative pt-24 sm:pt-28 md:pt-32 pb-16 sm:pb-20 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <span class="inline-flex items-center px-3 sm:px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-emerald-100 text-xs sm:text-sm font-medium mb-4 sm:mb-6 animate-slide-up">
                <svg class="w-3 h-3 sm:w-4 sm:h-4 mr-2 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                Layanan Pengaduan
            </span>
            ...
            <p class="text-base sm:text-lg md:text-xl text-white/80 mx-auto animate-slide-up delay-200 px-4">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-lg sm:rounded-lg p-4 sm:p-6 md:p-8 shadow-sm border border-border" x-intersect="$el.classList.add('animate-slide-up')">
                <div class="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                    ...
                    <div>
                        <h2 class="text-xl sm:text-xl font-bold text-foreground">Lacak Pengaduan</h2>
                        <p class="text-secondary text-xs sm:text-sm">Masukkan nomor tiket untuk melihat status pengaduan Anda</p>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-3 gap-6 sm:gap-8">
                ...
                <div class="lg:col-span-1 space-y-6">
                    <!-- About -->
                    <div class="bg-white rounded-lg p-6 shadow-sm border border-border" x-intersect="$el.classList.add('animate-slide-in-left')">
                        <div class="w-14 h-14 bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-lg flex items-center justify-center mb-4 shadow-emerald-500/30">
                            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
                        </div>
                        <h3 class="text-xl font-bold text-foreground mb-3">Tentang Layanan Ini</h3>
                        <p class="text-secondary text-sm leading-relaxed">Layanan pengaduan nasabah adalah saluran resmi untuk menyampaikan keluhan, saran, atau masukan terkait produk dan layanan {{ $companyInfo->name ?? 'BPR Syariah' }}.</p>
                    </div>

                    <!-- Categories -->
                    <div class="bg-white rounded-lg p-6 shadow-sm border border-border" x-intersect="$el.classList.add('animate-slide-in-left')">
                        <h3 class="text-xl font-bold text-foreground mb-4">Kategori Pengaduan</h3>
                        <ul class="space-y-3">
                            @php
                            ...
                            <li class="flex items-start">
                                <span class="w-6 h-6 bg-emerald-50 rounded-full flex items-center justify-center mr-3 mt-0.5 shrink-0">
                    ...
                    <!-- SLA Info -->
                    <div class="bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-lg p-6 text-white" x-intersect="$el.classList.add('animate-slide-in-left')">
                        ...
                        <h3 class="text-xl font-bold mb-3">Waktu Penyelesaian</h3>
                    ...
                    <!-- Contact -->
                    <div class="bg-white rounded-lg p-6 shadow-sm border border-border" x-intersect="$el.classList.add('animate-slide-in-left')">
                        <h3 class="text-xl font-bold text-foreground mb-4">Kontak Alternatif</h3>
                        <div class="space-y-3">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-medium text-foreground">{{ $companyInfo->email_complaint ?? $companyInfo->email ?? '-' }}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    <p class="text-sm text-secondary">Telepon</p>
                                    <p class="text-sm font-medium text-foreground">{{ $companyInfo->phone }}</p>
                                </div>
                            </div>
                            @endif
                        </div>
                    ...
                    <!-- Whistleblowing Link -->
                    <div class="bg-amber-50 rounded-lg p-6 border border-amber-200" x-intersect="$el.classList.add('animate-slide-in-left')">
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold text-amber-700 mb-1">Melaporkan Pelanggaran?</h4>
                                <p class="text-sm text-amber-700 mb-3">Untuk melaporkan dugaan kecurangan atau pelanggaran, gunakan Whistleblowing System.</p>
                                <a href="{{ route('whistleblowing') }}" class="inline-flex items-center text-sm font-medium text-amber-600 hover:text-amber-800">
                                    Ke Whistleblowing
                ...
                <div class="lg:col-span-2" x-intersect="$el.classList.add('animate-slide-in-right')">
                    <div class="bg-white rounded-lg sm:rounded-lg p-4 sm:p-6 md:p-8 shadow-sm border border-border">
                        <h2 class="text-2xl sm:text-2xl font-bold text-foreground mb-2">Form Pengaduan</h2>
                        <p class="text-sm sm:text-base text-secondary mb-6 sm:mb-8">Isi form di bawah ini untuk menyampaikan pengaduan Anda</p>
