        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10">
                ...
                <div class="space-y-4 sm:space-y-6 order-1 lg:order-2">
                    {{-- How It Works --}}
                    <div class="bg-white dark:bg-slate-900 rounded-lg sm:rounded-lg p-5 sm:p-6 lg:p-7 shadow-sm border-2 border-border hover:shadow-sm hover:-translate-y-1 transition-all duration-300">
                        <div class="flex items-center mb-4 sm:mb-5">
                            ...
                            <h3 class="font-black text-foreground dark:text-slate-100 text-xl">Cara Menggunakan</h3>
                        </div>
                    ...
                    {{-- Benefits --}}
                    <div class="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 rounded-lg sm:rounded-lg p-5 sm:p-6 lg:p-7 shadow-blue-200/50 dark:shadow-blue-900/30 border-2 border-blue-200 dark:border-blue-800/50 hover:shadow-sm hover:-translate-y-1 transition-all duration-300">
                        <div class="flex items-center mb-4 sm:mb-5">
                    ...
                    <div class="bg-gradient-to-br from-emerald-600 via-emerald-700 to-emerald-800 rounded-lg sm:rounded-lg p-6 sm:p-7 lg:p-8 text-white shadow-emerald-500/30 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
                        ...
                        <div class="relative">
                            ...
                            <a href="{{ route('contact') }}"
                               class="group inline-flex items-center justify-center w-full px-6 py-4 bg-white dark:bg-slate-800 text-emerald-600 dark:text-emerald-400 rounded-lg font-bold text-sm sm:text-base hover:bg-emerald-50 dark:hover:bg-emerald-900/50 transition-all duration-300 active:scale-95 min-h-[56px]">
