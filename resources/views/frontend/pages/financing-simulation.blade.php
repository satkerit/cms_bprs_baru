<x-frontend-layout>
    ...
    <section class="relative pt-24 sm:pt-28 md:pt-32 lg:pt-36 pb-16 sm:pb-20 md:pb-24 overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-emerald-600 via-emerald-700 to-emerald-800">
            ...
            <div class="absolute top-20 left-10 w-72 h-72 bg-emerald-400/20 rounded-full blur-3xl animate-pulse"></div>
            <div class="absolute bottom-10 right-10 w-96 h-96 bg-emerald-400/20 rounded-full blur-3xl animate-pulse"></div>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-base sm:text-lg md:text-xl lg:text-2xl text-emerald-50 max-w-3xl mx-auto px-4 leading-relaxed font-medium">
                ...
                <div class="space-y-4 sm:space-y-6 order-1 lg:order-2">
                    ...
                    <div class="bg-white rounded-lg sm:rounded-lg p-5 sm:p-6 lg:p-7 shadow-sm border-2 border-border hover:shadow-sm hover:-translate-y-1 transition-all duration-300">
                        <div class="flex items-center mb-4 sm:mb-5">
                            <div class="w-12 h-12 bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-lg flex items-center justify-center mr-3">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                            </div>
                            <h3 class="font-black text-foreground text-xl sm:text-xl">Cara Menggunakan</h3>
                        </div>
                    ...
                    <div class="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg sm:rounded-lg p-5 sm:p-6 lg:p-7 shadow-blue-200/50 border-2 border-blue-200 hover:shadow-sm hover:-translate-y-1 transition-all duration-300">
                        <div class="flex items-center mb-4 sm:mb-5">
                            ...
                            <h3 class="font-black text-foreground text-xl sm:text-xl">Keunggulan Kami</h3>
                        </div>
                        <ul class="space-y-3 sm:space-y-4">
                            <li class="flex items-center group">
                                <div class="w-8 h-8 bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-lg flex items-center justify-center mr-3 shrink-0 group-hover:scale-110 transition-transform duration-300">
                                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/>
                                    </svg>
                                </div>
                                <span class="text-sm sm:text-base text-secondary font-medium">Proses cepat dan mudah</span>
                            </li>
                            <li class="flex items-center group">
                                <div class="w-8 h-8 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-lg flex items-center justify-center mr-3 shrink-0 group-hover:scale-110 transition-transform duration-300">
                                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/>
                                    </svg>
                                </div>
                                <span class="text-sm sm:text-base text-secondary font-medium">Margin kompetitif</span>
                            </li>
                            <li class="flex items-center group">
                                <div class="w-8 h-8 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mr-3 shrink-0 group-hover:scale-110 transition-transform duration-300">
                                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/>
                                    </svg>
                                </div>
                                <span class="text-sm sm:text-base text-secondary font-medium">Sesuai prinsip syariah</span>
                            </li>
                            <li class="flex items-center group">
                                <div class="w-8 h-8 bg-gradient-to-br from-amber-500 to-orange-500 rounded-lg flex items-center justify-center mr-3 shrink-0 group-hover:scale-110 transition-transform duration-300">
                                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/>
                                    </svg>
                                </div>
                                <span class="text-sm sm:text-base text-secondary font-medium">Angsuran tetap</span>
                            </li>
                            <li class="flex items-center group">
                                <div class="w-8 h-8 bg-gradient-to-br from-green-500 to-emerald-600 rounded-lg flex items-center justify-center mr-3 shrink-0 group-hover:scale-110 transition-transform duration-300">
                                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/>
                                    </svg>
                                </div>
                                <span class="text-sm sm:text-base text-secondary font-medium">Tenor fleksibel</span>
                            </li>
                        </ul>
                    </div>

                    <!-- Contact CTA -->
                    <div class="bg-gradient-to-br from-emerald-600 via-emerald-700 to-emerald-800 rounded-lg sm:rounded-lg p-6 sm:p-7 lg:p-8 text-white shadow-emerald-500/30 hover:shadow-3xl hover:-translate-y-1 transition-all duration-300 relative overflow-hidden">
                        ...
                        <div class="relative">
                            ...
                            <h3 class="font-black text-2xl sm:text-2xl mb-3">Tertarik dengan Pembiayaan?</h3>
                            ...
                            <a href="{{ route('contact') }}" class="group inline-flex items-center justify-center w-full px-6 py-4 bg-white text-emerald-600 rounded-lg font-bold text-sm sm:text-base hover:bg-emerald-50 transition-all duration-300 hover:shadow-sm touch-manipulation active:scale-95 min-h-[56px]">
                                <svg class="w-5 h-5 mr-2 shrink-0 group-hover:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                                </svg>
                                Hubungi Kami Sekarang
                                <svg class="w-5 h-5 ml-2 shrink-0 group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
