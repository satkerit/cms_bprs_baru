...
<body class="font-sans antialiased admin-auction-scroll">
            ...
            <header class="admin-auction-header p-6">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        <!-- Mobile Menu Button -->
                        <button class="lg:hidden text-white" data-toggle-sidebar>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="hidden md:flex items-center space-x-6 text-white">
                            <div class="text-center">
                                <div class="text-lg font-bold">{{ \App\Models\Auction::getCachedStats()['total'] }}</div>
                                <div class="text-xs text-orange-200">Total Lelang</div>
                            </div>
                            <div class="text-center">
                                <div class="text-lg font-bold">{{ \App\Models\Auction::getCachedStats()['registration_open'] }}</div>
                                <div class="text-xs text-orange-200">Aktif</div>
                            </div>
                            <div class="text-center">
                                <div class="text-lg font-bold">{{ \App\Models\Auction::getCachedStats()['sold'] }}</div>
    ...
    <script nonce="{{ $nonce }}">
        ...
        document.addEventListener('click', function(event) {
            ...
            const isClickOnMenuButton = event.target.closest('[data-toggle-sidebar]');
