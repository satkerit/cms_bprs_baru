<div x-data="prayerTimeWidget()" x-init="init()" class="bg-gradient-to-br from-emerald-600 to-emerald-800 rounded-t-3xl sm:rounded-2xl shadow-2xl overflow-hidden">
    <!-- Compact Header -->
