    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-wrap justify-center items-start gap-8 md:gap-16 max-w-4xl mx-auto">
            ...
            <div class="text-center stats-card fade-in-section min-w-[140px]">
                ...
                <div class="stats-counter text-3xl font-bold text-foreground mb-1 tracking-tight" data-target="{{ $companyInfo->stat_years_experience }}" data-suffix="+">0+</div>
            ...
            <div class="text-center stats-card fade-in-section min-w-[140px]">
                ...
                <div class="stats-counter text-3xl font-bold text-foreground mb-1 tracking-tight" data-target="{{ $companyInfo->stat_branch_offices }}" data-suffix="+">0+</div>
            ...
            <div class="text-center stats-card fade-in-section min-w-[140px]">
                ...
                <div class="stats-counter text-3xl font-bold text-foreground mb-1 tracking-tight" data-target="{{ $companyInfo->stat_cash_offices }}" data-suffix="+">0+</div>
            ...
            <div class="text-center stats-card fade-in-section min-w-[140px]">
                ...
                <div class="stats-counter text-3xl font-bold text-foreground mb-1 tracking-tight" data-target="{{ $companyInfo->stat_mobile_cash_offices }}" data-suffix="+">0+</div>
