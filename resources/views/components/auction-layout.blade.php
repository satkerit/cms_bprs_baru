...
<body class="font-sans antialiased text-gray-800 auction-scroll">
    ...
    <div class="fixed bottom-8 right-8 flex flex-col gap-3 z-40 no-print">
        ...
        <button @click="document.querySelector('#auction-search')?.focus()"
                class="w-14 h-14 bg-gradient-to-r from-emerald-600 to-emerald-700 text-white rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all duration-300 hover:scale-110"
                title="Quick Search">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
