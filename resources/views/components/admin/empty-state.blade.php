...
@endphp    <div {{ $attributes->merge(['class' => 'py-12 px-6 text-center']) }}>
    {{-- Icon with decorative bg --}}
    <div class="relative w-20 h-20 mx-auto mb-5">
        <div class="absolute inset-0 bg-gradient-to-br from-emerald-50 dark:from-emerald-950/40 via-emerald-50/50 dark:via-emerald-950/20 to-transparent rounded-2xl"></div>
        <div class="absolute inset-2 bg-white dark:bg-slate-800 rounded-xl flex items-center justify-center shadow-sm ring-1 ring-emerald-100/50 dark:ring-emerald-800/50">
    ...
    {{-- Title --}}
    <h3 class="text-[15px] font-semibold text-slate-900 dark:text-slate-100 mb-1">{{ $title }}</h3>
